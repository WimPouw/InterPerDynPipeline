...
```{python examplecsvfilelayer2}
import pandas as pd
import glob as glob
import os

folderstep1output = "./dataoutput_STEP1_2_timeseries/"
# Load the CSV file
csv_file = glob.glob(os.path.join(folderstep1output + "*.csv"))[0]
df = pd.read_csv(csv_file)
...
folderstep1output = "./dataoutput_STEP2_features/smoothness_data.csv"
# Load the CSV file
csv_file = glob.glob(os.path.join(folderstep1output + "*.csv"))[0]
df = pd.read_csv(csv_file)
...
folderstep1output = "./dataoutput_STEP2_features/tsfresh_features_fromCOMdistance.csv"
# Load the CSV file
csv_file = glob.glob(os.path.join(folderstep1output + "*.csv"))[0]
df = pd.read_csv(csv_file)
