...
- **example output** that shows example output. Denoted with the symbol 📊.

- **DIY blocks** that provide shorter, step-by-step links to the full code for executing a particular step in the pipeline on your own code 🛠️.
