...
# main variables
video_folder = "./data_sample_data_raw/"
video_files = glob.glob(video_folder + "*.mp4")
step1resultfolder = "./data_sample_data_raw/step1result/" # we can replace with full data
...
for video_path in video_files:
    ...
    output_path = step1resultfolder+"{corename}_output.mp4"
